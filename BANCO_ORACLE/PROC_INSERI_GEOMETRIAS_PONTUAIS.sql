...
CREATE OR REPLACE PROCEDURE PROC_INSERI_GEOMETRIAS_PONTUAIS
AS 
    VGEOM SDO_GEOMETRY;
BEGIN
    ...
    LOOP
        BEGIN
            SELECT MDSYS.SDO_GEOMETRY(2003,null, MDSYS.SDO_POINT_TYPE(C1.LONGITUDE,C1.LATITUDE,NULL),NULL,NULL)
              INTO VGEOM
